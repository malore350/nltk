...
# map of the unicode escape sequences
modify = {'\u2018|\u2019|\u201c|\u201d': '\'', '\u2013|\u2212': '-', '-\n': '', '\n|\r': ' '}
...
for pdf_file_name in pdf_files:
    ...
    for i in range(num_pages):
        ...
        # Extract the text from the page & normalize
        page_text = unicodedata.normalize("NFKD", page.extract_text())
    ...
    # Use regular expressions to extract the content of the Keywords section
    ...
    # Save the keywords data to JSON file
    with open("data1.json", "a") as json_file:
        json.dump(data, json_file)
        json_file.write('\n')

    # Map the Unicode escape sequences into reasonable string
    for key in modify:
        text = re.sub(key, modify[key], text)
